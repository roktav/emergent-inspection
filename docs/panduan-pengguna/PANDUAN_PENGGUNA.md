...
4. Untuk temuan (status bukan OK), isi **Catatan temuan** (*Jelaskan temuan...*).
...
2. **Jepret**.
3. **Ulangi** atau **Gunakan foto**.
4. Tunggu **Memproses...** (kompresi, maksimum 500 KB).
...
*Gambar 4. Semua item mulai sebagai OK. Ubah status, catatan, dan foto hanya pada temuan.*
...
3. **Tipe Inspeksi** — **Nama**, **Kode**, **Deskripsi**, **Aktif**. Dipilih saat mulai inspeksi; tidak mengubah isi checklist.
...
*Gambar 9. Pasang kategori inspeksi ke kategori kendaraan/aset.*
...
*Gambar 10. Admin perusahaan wajib memilih Site saat menambah kendaraan/aset.*
...
Perusahaan
  ...
  └─ Site
       └─ Unit (Daftar Kendaraan/Aset)  ── satu kategori kendaraan
            └─ Checklist = item dari kategori inspeksi yang terpasang
```
...
**Unit tidak punya checklist.**  
Minta Admin Perusahaan memasang **Kategori Inspeksi** ke **Kategori Kendaraan/Aset** unit itu.
